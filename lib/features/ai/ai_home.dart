...
import 'package:ua_mobile_health/features/ai/prompt_box.dart';
...
class AIHomePage extends StatefulWidget {
  const AIHomePage({Key key, @required this.username}) : super(key: key);
              ...
              child: Visibility(
                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      generatedContent ??
                          'Hi ${ReCase(widget.username).sentenceCase}, what can I do for you?',
                      style: TypographyStyle.bodyMediumn.copyWith(
                        fontSize: generatedContent == null ? 16.sp : 16.sp,
                      ),
                    ),
                  ),
                ),
                ...
                children: [
                  ...
                  FadeInUp(
                    ...
                    child: const FeatureBox(
                      ...
                      descriptionText:
                          'A smarter way to informed  and stay up to date with your health symptoms.',
                    ),
                  ),
                  FadeInUp(
                    ...
                    child: const FeatureBox(
                      ...
                      headerText: 'Generate Image for you.',
                      descriptionText:
                          'Visual illustration to help you understand your physical symptoms.',
                    ),
                  ),
                  FadeInUp(
                    ...
                    child: const FeatureBox(
                      ...
                      descriptionText:
                          'Get the best of both worlds with our interactive voice assistant.',
                    ),
                  ),
                ],
              ),
